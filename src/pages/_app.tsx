    ...
    <ErrorBoundary>
      {/* <ThemeProvider {...config}> */}
        <Provider store={store}>
          ...
          <Layout dataHeader={pageProps.dataHeader} cachedTheme={pageProps.cachedTheme} dataFooter={pageProps.dataFooter} dataModal={pageProps.dataModal}>
            <Component {...pageProps} />
          </Layout>
          </div>
        </Provider>
...
App.getInitialProps = async ({ Component, router, ctx:{ req,res },  }: AppContext) => {

 
  
  let cachedTheme = getCookie('theme', { req, res });
  if(!cachedTheme){
