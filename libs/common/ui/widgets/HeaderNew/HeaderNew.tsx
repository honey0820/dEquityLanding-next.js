...
export const HeaderNew = ({
  ...
  const [initTheme,setTheme] = useState<boolean>()
        ...
        <div
            ...
            <div className={style.header__nav_item}>
             ...
             <div className={style.header__theme_switch} onClick={()=> {
              ...
              <div className={ themeSelector == "theme-dark" ? cl(style.header__theme_switch_dark, style.header__theme_switch_icon, style.header__theme_switch_icon_active) : cl(style.header__theme_switch_dark, style.header__theme_switch_icon)}>
                {/* <img src={MoonSvg.src} /> */}
                <MoonSvg/>
              </div>
             </div>
