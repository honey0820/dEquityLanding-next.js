...
import graficDark from "../../../assets/imgs/newResearch/ImmediateRentDark.svg";
import graficWith from "../../../assets/imgs/newResearch/ImmediateRentWith.svg";
      ...
      <>
         <div className={style.ImmediateRent}>
            ...
            <div className={style.ImmediateRent__img}>
               <img src={theme === 'theme-dark' ? graficDark.src : graficWith.src} alt={data?.data?.attributes?.iRent_title} />
            </div>
