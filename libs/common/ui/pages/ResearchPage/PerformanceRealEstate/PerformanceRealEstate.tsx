...
import gragicDark from "../../../assets/imgs/newResearch/PerformanceRealEstateDark.svg";
import gragicWith from "../../../assets/imgs/newResearch/PerformanceRealEstateWith.svg";
      ...
      <>
         <div className={style.performanceRealEstate}>
            ...
            <div className={style.performanceRealEstate__img}>
               <img src={theme === 'theme-dark' ? gragicDark.src : gragicWith.src} alt="Performance real estate vs. others" />
