...
import graficDark   from "@/libs/common/ui/assets/imgs/newResearch/MiamiRealEstateDark.svg";
import graficWith   from "@/libs/common/ui/assets/imgs/newResearch/MiamiRealEstateWith.svg";
      ...
      <>
         <div className={style.MiamiRealEstate}>
            ...
            <div className={style.MiamiRealEstate__img}>
               <img src={theme === 'theme-dark' ? graficDark.src : graficWith.src} alt={data?.data?.attributes?.miami_title} />
            </div>
